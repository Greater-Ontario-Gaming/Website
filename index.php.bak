...
<div class="row home-row">
    <div class="col-md home-text">
        <div class="content" data-aos="fade-right">
            ...
            <ul>
                <li>
                    <a href="/tps">Toronto Police Service</a>
                </li>
                <li>
                    <a href="/opp">Ontario Provincial Police</a>
                </li>
                <li>
                    <a href="/emsfire">Toronto Fire &amp; EMS</a>
                </li>
                <li>
                    <a href="/civ">Civilian Operations</a>
                </li>
            </ul> */
            ?>
        </div>
    </div>
    <div class="col-md home-img home-img2"></div>
</div>

<div class="row home-row">
    <div class="col-md home-img home-img3"></div>
    <div class="col-md home-text">
        <div class="content" data-aos="fade-left">
...
<div class="row home-row">
    ...
    <div class="col-md home-img home-img4"></div>
</div>

<div class="row home-row">
    <div class="col-md home-img home-img5"></div>
    <div class="col-md home-text">
        <div class="content" data-aos="fade-left">
            <h2>More than just driving cars</h2>
            <p>Many of our departments have subdivisions.  Once you're promoted to Constable III or higher, you can apply to one of many specialized units.</p>
            <p>Traffic enforcement, emergency response team, drug &amp; gang unit, air unit, search &amp; rescue, and so much more!  Many units have their own special vehicles or equipment, like our ORNGE helicopter for example.</p>
        </div>
    </div>
</div>
